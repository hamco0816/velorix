...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			PromoRateMultiplier:             apiKey.Group.PromoRateMultiplier,
			PromoStartsAt:                   apiKey.Group.PromoStartsAt,
			PromoEndsAt:                     apiKey.Group.PromoEndsAt,
			PromoLabel:                      apiKey.Group.PromoLabel,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			PromoRateMultiplier:             snapshot.Group.PromoRateMultiplier,
			PromoStartsAt:                   snapshot.Group.PromoStartsAt,
			PromoEndsAt:                     snapshot.Group.PromoEndsAt,
			PromoLabel:                      snapshot.Group.PromoLabel,
