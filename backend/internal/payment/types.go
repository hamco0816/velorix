...
type CreatePaymentResponse struct {
	...
	QRCode       string                  // QR code content for scanning (rendered by qrcode.js on the frontend)
	QRCodeImage  string                  // Pre-rendered QR PNG URL provided by upstream, embed via <img>
