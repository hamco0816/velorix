...
type PaymentOrder struct {
	...
	// RenewalSeatID holds the value of the "renewal_seat_id" field.
	RenewalSeatID *int64 `json:"renewal_seat_id,omitempty"`
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentorder.FieldID, paymentorder.FieldUserID, paymentorder.FieldPlanID, paymentorder.FieldSubscriptionGroupID, paymentorder.FieldSubscriptionDays, paymentorder.FieldRenewalSeatID, paymentorder.FieldInvoiceRequestID:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldRenewalSeatID:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field renewal_seat_id", values[i])
			} else if value.Valid {
				_m.RenewalSeatID = new(int64)
				*_m.RenewalSeatID = value.Int64
			}
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.RenewalSeatID; v != nil {
		builder.WriteString("renewal_seat_id=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
