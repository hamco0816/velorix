...
type User struct {
	...
	// InvoiceableConsumed holds the value of the "invoiceable_consumed" field.
	InvoiceableConsumed float64 `json:"invoiceable_consumed,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged, user.FieldInvoiceableConsumed:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldInvoiceableConsumed:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field invoiceable_consumed", values[i])
			} else if value.Valid {
				_m.InvoiceableConsumed = value.Float64
			}
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("invoiceable_consumed=")
	builder.WriteString(fmt.Sprintf("%v", _m.InvoiceableConsumed))
	builder.WriteString(", ")
