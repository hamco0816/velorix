...
func (_u *UserSubscriptionUpdate) SetRateMultiplier(v float64) *UserSubscriptionUpdate {
...
func (_u *UserSubscriptionUpdate) SetNillableRateMultiplier(v *float64) *UserSubscriptionUpdate {
	if v != nil {
...
func (_u *UserSubscriptionUpdate) AddRateMultiplier(v float64) *UserSubscriptionUpdate {
	_u.mutation.AddRateMultiplier(v)
	return _u
}

// ClearRateMultiplier clears the value of the "rate_multiplier" field.
func (_u *UserSubscriptionUpdate) ClearRateMultiplier() *UserSubscriptionUpdate {
...
func (_u *UserSubscriptionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedRateMultiplier(); ok {
		_spec.AddField(usersubscription.FieldRateMultiplier, field.TypeFloat64, value)
	}
	if _u.mutation.RateMultiplierCleared() {
		_spec.ClearField(usersubscription.FieldRateMultiplier, field.TypeFloat64)
	}
...
// SetRateMultiplier sets the "rate_multiplier" field.
func (_u *UserSubscriptionUpdateOne) SetRateMultiplier(v float64) *UserSubscriptionUpdateOne {
	_u.mutation.ResetRateMultiplier()
	_u.mutation.SetRateMultiplier(v)
	return _u
}
...
// SetNillableRateMultiplier sets the "rate_multiplier" field if the given value is not nil.
func (_u *UserSubscriptionUpdateOne) SetNillableRateMultiplier(v *float64) *UserSubscriptionUpdateOne {
	if v != nil {
		_u.SetRateMultiplier(*v)
	}
	return _u
...
// AddRateMultiplier adds value to the "rate_multiplier" field.
func (_u *UserSubscriptionUpdateOne) AddRateMultiplier(v float64) *UserSubscriptionUpdateOne {
	_u.mutation.AddRateMultiplier(v)
	return _u
}

// ClearRateMultiplier clears the value of the "rate_multiplier" field.
func (_u *UserSubscriptionUpdateOne) ClearRateMultiplier() *UserSubscriptionUpdateOne {
	_u.mutation.ClearRateMultiplier()
	return _u
}
