      ...
      <div class="rounded-2xl bg-gray-50 p-4 dark:bg-dark-700/50">
        ...
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2">
          ...
          <details class="col-span-1 md:col-span-2">
            <summary class="cursor-pointer text-xs font-medium text-info hover:text-info-deep dark:text-info">
  ...
  <BaseDialog :show="showAlertEditor" :title="t('admin.ops.runtime.alertTitle')" width="extra-wide" @close="showAlertEditor = false">
    <div v-if="draftAlert" class="space-y-4">
      <div
        ...
        class="rounded-lg border border-warning/30 bg-warning-soft p-3 text-xs text-warning-deep dark:border-warning/40 dark:bg-warning/10 dark:text-warning"
      >
          ...
          <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-800">
            <div class="flex items-start justify-between gap-4">
              <div>
                ...
                <p class="text-2xs text-gray-500 dark:text-gray-400">{{ t('admin.ops.runtime.silencing.entries.hint') }}</p>
              </div>
      ...
      <details class="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-dark-600 dark:bg-dark-800">
        ...
        <div class="mt-3 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div class="md:col-span-2">
            ...
            <p v-if="draftAlert.distributed_lock.enabled" class="mt-1 text-2xs text-gray-500 dark:text-gray-400">
