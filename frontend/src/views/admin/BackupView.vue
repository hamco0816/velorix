        ...
        <div v-if="showR2Guide" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showR2Guide = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-2xl dark:bg-dark-800">
            ...
            <div class="mb-5">
              ...
              <div class="mt-2 rounded-lg bg-warning-soft p-3 text-xs text-warning dark:bg-warning-deep/30 dark:text-brand-300">
            ...
            <!-- Free tier note -->
            <div class="rounded-lg bg-success-soft p-3 text-xs text-success dark:bg-success-deep/30 dark:text-tea-300">
...
function statusClass(status: string): string {
  switch (status) {
    ...
    case 'running':
      return 'bg-info-soft text-info dark:bg-info-deep/30 dark:text-info'
    case 'failed':
      return 'bg-danger-soft text-danger dark:bg-danger-deep/30 dark:text-danger'
    default:
