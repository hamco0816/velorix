    ...
    <div class="w-full max-w-md space-y-6">
      ...
      <template v-else>
        ...
        <div class="text-center">
          <div v-if="isSuccess"
            class="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-success-soft dark:bg-success/20">
          ...
          <div v-else-if="isPending"
            class="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-warning-soft dark:bg-warning/20">
            <div class="h-10 w-10 animate-spin rounded-full border-4 border-warning border-t-transparent"></div>
          </div>
          <div v-else
            class="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-danger-soft dark:bg-danger/20">
        ...
        <!-- Order Info -->
        <div v-if="order" class="rounded-xl bg-white p-5 shadow-card dark:bg-dark-800">
        ...
        <div v-else-if="returnInfo" class="rounded-xl bg-white p-5 shadow-card dark:bg-dark-800">
          <div class="space-y-3 text-sm">
