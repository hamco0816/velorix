...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: () => import('@/views/admin/pricing/AdminModelPricingView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Model Pricing',
      titleKey: 'admin.pricing.title',
      descriptionKey: 'admin.pricing.subtitle'
    }
  },
  {
    path: '/admin/pricing/advisor',
    name: 'AdminPricingAdvisor',
    component: () => import('@/views/admin/PricingAdvisorView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Pricing Advisor',
      titleKey: 'admin.pricingAdvisor.title',
      descriptionKey: 'admin.pricingAdvisor.subtitle',
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      descriptionKey: 'support.admin.subtitle'
    }
  },
  {
    path: '/admin/proxies',
