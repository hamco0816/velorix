        ...
        >
          ...
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              class="rounded-lg p-1.5 text-gray-500 hover:bg-danger-soft hover:text-danger dark:hover:bg-danger-soft dark:hover:text-danger"
      ...
      <div v-if="form.type === 'select' || form.type === 'multi_select'" class="space-y-2">
        ...
        <div v-for="(option, index) in form.options" :key="getOptionKey(option)" class="flex items-center gap-2">
          ...
          <button
            ...
            class="rounded-lg p-1.5 text-gray-500 hover:bg-danger-soft hover:text-danger"
          >
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        ...
        <button type="submit" form="attribute-form" :disabled="saving" class="btn btn-primary">
          <LoadingSpinner v-if="saving" size="sm" color="current" class="-ml-1 mr-2" />
