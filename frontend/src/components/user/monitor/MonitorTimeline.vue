<template>
  <div class="mt-4 pt-3 border-t border-gray-100 dark:border-dark-700/60">
    <div
      class="flex justify-between text-2xs font-semibold uppercase tracking-widest text-gray-400 mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-gray-300 dark:border-dark-600 text-2xs uppercase tracking-widest text-gray-400"
    >
    ...
    <div
      class="mt-1 flex justify-between text-2xs uppercase tracking-widest text-gray-400"
    >
