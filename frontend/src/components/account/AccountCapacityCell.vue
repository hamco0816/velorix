...
const concurrencyClass = computed(() => {
  ...
  if (current >= max) return 'bg-danger-soft text-danger dark:bg-danger-deep/30 dark:text-danger'
  if (current > 0) return 'bg-warning-soft text-warning dark:bg-warning-deep/30 dark:text-brand-300'
  return 'bg-gray-100 text-gray-600 dark:bg-dark-800 dark:text-dark-400'
})
...
const windowCostClass = computed(() => {
  ...
  if (current >= limit + reserve) return 'bg-danger-soft text-danger dark:bg-danger-deep/30 dark:text-danger'
  if (current >= limit) return 'bg-warning-soft text-warning-deep dark:bg-warning-deep/40 dark:text-brand-200'
  if (current >= limit * 0.8) return 'bg-warning-soft text-warning dark:bg-warning-deep/30 dark:text-brand-300'
  return 'bg-success-soft text-success dark:bg-success-deep/30 dark:text-tea-300'
})
...
const sessionLimitClass = computed(() => {
  ...
  if (current >= max) return 'bg-danger-soft text-danger dark:bg-danger-deep/30 dark:text-danger'
  if (current >= max * 0.8) return 'bg-warning-soft text-warning dark:bg-warning-deep/30 dark:text-brand-300'
  return 'bg-success-soft text-success dark:bg-success-deep/30 dark:text-tea-300'
})
...
const rpmClass = computed(() => {
  ...
  if (rpmStrategy.value === 'tiered') {
    if (current >= base + buffer) return 'bg-danger-soft text-danger dark:bg-danger-deep/30 dark:text-danger'
    if (current >= base) return 'bg-warning-soft text-warning-deep dark:bg-warning-deep/40 dark:text-brand-200'
  } else {
    if (current >= base) return 'bg-warning-soft text-warning-deep dark:bg-warning-deep/40 dark:text-brand-200'
  }
  if (current >= base * 0.8) return 'bg-warning-soft text-warning dark:bg-warning-deep/30 dark:text-brand-300'
  return 'bg-success-soft text-success dark:bg-success-deep/30 dark:text-tea-300'
})
