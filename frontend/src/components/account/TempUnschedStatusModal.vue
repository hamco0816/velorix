  ...
  >
    <div class="space-y-4">
      <div v-if="loading" class="flex items-center justify-center py-8">
        <LoadingSpinner size="base" color="current" class="h-6 w-6 text-gray-400" />
      </div>
      ...
      <div v-else class="space-y-4">
        <div class="rounded-lg border border-success/30 bg-success-soft p-3 text-sm text-success-deep dark:border-success/30 dark:bg-success-deep/30 dark:text-tea-300">
    ...
    <template #footer>
      <div class="flex justify-end gap-3">
        ...
        <button
          ...
          @click="handleReset"
        >
          <LoadingSpinner v-if="resetting" size="sm" color="current" class="-ml-1 mr-2" />
