...
export const PROVIDER_CONFIG_FIELDS: Record<string, ConfigFieldDef[]> = {
  ...
  xunhupay: [
    { key: 'appid', label: '通用 AppID（兼容旧配置）', sensitive: false, optional: true },
    { key: 'appsecret', label: '通用 AppSecret（兼容旧配置）', sensitive: true, optional: true },
    { key: 'alipayAppId', label: '支付宝 AppID', sensitive: false, optional: true },
    { key: 'alipayAppSecret', label: '支付宝 AppSecret', sensitive: true, optional: true },
    { key: 'wxpayAppId', label: '微信 AppID', sensitive: false, optional: true },
    { key: 'wxpayAppSecret', label: '微信 AppSecret', sensitive: true, optional: true },
    { key: 'apiBase', label: '', sensitive: false, optional: true, defaultValue: 'https://api.xunhupay.com' },
    { key: 'callbackUrl', label: '', sensitive: false, optional: true },
  ],
  alipay: [
