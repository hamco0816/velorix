<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <div class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-md ring-1 ring-primary-200 dark:ring-primary-700">
    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M12 3.75l7.5 3v5.25c0 4.3-2.75 8.16-7.5 9.75-4.75-1.59-7.5-5.45-7.5-9.75V6.75l7.5-3z'
        }),
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/desktop-releases', label: t('nav.desktopReleases'), icon: ServerIcon, hideInSimpleMode: true, group: 'admin-operation' },
