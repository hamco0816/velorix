  ...
  admin: {
    ...
    pricingAdvisor: {
      ...
      calculator: {
        ...
        usersPerAccountTip: 'How many subscribers will share one account. The upstream cap × safety is split across N users to derive each user\'s 5h / daily / weekly / monthly quota; the price = cost × (1+markup) ÷ (N × occupancy).',
        markup: 'Markup',
        ...
        profitTip: 'Profit at the current occupancy. Full-occupancy (100%) profit: ¥{full}. Negative means current price + occupancy can\'t cover account cost.',
        perMonth: 'mo',
        limitsTitle: 'Per-user subscription limits (USD)',
        limitsTip: '5h limit = cap_5h × safety / N; weekly = cap_7d × safety / N; daily = weekly/7; monthly = weekly×4. cap is reverse-derived from utilization when available, else falls back to 7d_P95.',
        limitsSourceReversed: 'Source: cap_5h={cap5h}$ · cap_7d={cap7d}$ (median of {samples} accounts via utilization), × safety {safety} ÷ N={n}',
        limitsSourceFallback: 'No utilization samples; falling back to 7d_P95 as cap: cap_5h≈{cap5h}$ · cap_7d≈{cap7d}$, × safety {safety} ÷ N={n}',
        limitsCapsIndependentNote: 'Note: the 4 limits are independent caps; whichever the user hits first is binding.',
        applyToPlan: 'Create plan with this suggestion',
        warnNoCapSample: 'No utilization sample for this tier — falling back to 7d_P95 estimate. Results will get more accurate once passive sampling collects more data.',
