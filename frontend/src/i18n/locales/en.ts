export default {
  ...
  nav: {
    ...
    exclusivePools: 'Exclusive Pools',
  ...
  auth: {
    ...
    turnstileLoading: 'Verifying…',
    turnstileVerified: 'Verified',
    turnstileLoadSlow: 'Verification is taking longer than usual, possibly a network issue.',
    turnstileRetry: 'Click to retry',
  ...
  pricing: {
    ...
    imagePer1K: '1K per image',
    imagePer2K: '2K per image',
    imagePer4K: '4K per image',
    imageRateNote: 'Group uses independent image rate; prices applied at {rate}',
    noPricing: 'Pricing not configured',
    tiered: 'Tiered',
    tieredHint: 'Tiered pricing across token ranges',
    availableIn: 'Available in (click to switch group)',
    switchToGroup: 'Switch to "{name}" group pricing',
  ...
  imageGen: {
    title: 'Image Studio',
    subtitle: 'Generate images directly from a prompt, no code required. Beta — results are NOT saved, download promptly.',
    promptPlaceholder: 'Describe what you want to generate. e.g. An orange kitten in a spacesuit on the moon looking at Earth, photorealistic',
    countLabel: 'imgs',
    aspectAuto: 'aspect auto',
    qualityLow: 'Quality low',
    qualityMedium: 'Quality standard',
    qualityHigh: 'Quality high',
    noKeyError: 'You have no API keys yet.',
    noKeyForGroup: 'No API key available for the selected group "{group}" yet.',
    createKeyHere: 'Create a key & continue',
    creatingKey: 'Creating…',
    referenceUpload: 'Upload reference image (img2img)',
    referenceShort: 'Reference',
    referencePrivacyHint: 'Used only for this generation, not stored on our servers',
    referenceTooLarge: 'Reference image too large (>4MB). Please compress and retry.',
    referenceTooMany: 'Up to {n} reference images',
    referenceRemove: 'Remove',
    submitTooltip: 'Generate (⌘/Ctrl + Enter)',
    resultsTitle: 'Results',
    previewHint: 'Drawing in progress — this will be replaced by the final HD image. Do not save yet.',
    download: 'Download',
    open: 'Open full',
    emptyHint: 'Fill in a prompt then click the ↑ button to generate',
    notSavedHint: 'Beta: results are not stored. Refresh or leave to lose them. Click "Download" to keep.',
    errorHeader: 'Generation failed',
    errorRetry: 'Retry',
    statusPrep: 'Preparing',
    statusStart: 'Generating',
    statusRefine: 'Refining',
    statusRefineWithCount: 'Refining {idx}/{total}',
  ...
  admin: {
    ...
    groups: {
      ...
      activeSubscriptionsHint: 'Number of active (non-expired) subscriptions on this group',
      ...
      form: {
        ...
        invoiceEligible: 'Consumption is invoiceable',
        invoiceEligibleHint: 'When enabled, real consumption in this group (pay-as-you-go balance + plan purchases) counts toward the invoiceable amount. Off by default — invoicing low-margin relayed groups loses money, so keep it off for those.',
    ...
    pricingAdvisor: {
      ...
      subtitle: 'Estimate the 7-day rolling peak cost per account tier from historical usage, helping you size subscription quotas and pricing.',
      daySuffix: 'd',
      helpTitle: 'How to read & use this',
      helpBody: 'The calculator prefers reverse-derived caps: cap = current-window cost ÷ upstream utilization%. e.g. 7d window at 50%, $10 spent → cap = $20. The "Daily / Weekly / Monthly" columns on the right are single-account tier ceilings: weekly = cap_7d, daily = cap_7d ÷ 7, monthly = cap_7d × 30 ÷ 7 (30-day month). The calculator then splits these across N users. The 5h / 7d table columns are sliding-window peaks over the last N days for reference only; when a tier has no utilization sample, cap falls back to 7d_P95.',
      helpUsdNote: 'USD here is "token-equivalent USD" (priced from token counts), not what you paid for the account. Use it directly when setting subscription quotas — that uses the same unit.',
      tableTitle: 'Per-tier usage stats (USD)',
      col: {
        platform: 'Platform',
        tier: 'Tier',
        samples: 'Samples',
      ...
      tip: {
        ...
        max: 'Heaviest account in this tier. Not for quota sizing — just to spot outliers.',
      },
      samplesLow: 'Less than 3 samples; P95 is noisy',
      empty: {
        title: 'No usage data yet',
        description: 'Stats fill in once accounts have traffic. Make sure each account is tagged with a subscription tier on the Accounts page.',
      },
      samples: 'samples',
      calculator: {
        title: 'Quota calculator',
        tier: 'Tier',
        usersPerAccount: 'Users per account (N)',
        usersPerAccountTip: 'How many subscribers will share one account. The upstream cap is split across N users to derive each user\'s daily / weekly / monthly / 5h limit. N=1 gives the single-account tier ceiling.',
        selectFirst: 'Pick a tier first, then fill in the parameters.',
        tierCapTitle: 'Tier cap (upstream capacity)',
        capSource_override: 'manual',
        capSource_reversed: 'utilization-reversed',
        capSource_fallback: '7d_P95 fallback (rough)',
        limitsTitle: 'Per-user limits (USD)',
        limitsTip: '5h limit = cap_5h × rate_multiplier / N; weekly = cap_7d × rate_multiplier / N; daily = weekly ÷ 7; monthly = weekly × 30 ÷ 7 (30-day month).',
        limitsCapsIndependentNote: 'The 4 limits are independent caps; whichever the user hits first is binding. 5h is reference-only — the plan model doesn\'t store 5h, enforce it upstream.',
        suggested5h: '5h limit',
        suggested5hRefMark: '(ref)',
        suggestedDaily: 'Daily',
        suggestedWeekly: 'Weekly',
        suggestedMonthly: 'Monthly',
        advancedTitle: 'Advanced (defaults usually fine)',
        advancedHint: 'Use manual cap override when reversed cap is too low; use multiplier when the plan has rate_multiplier ≠ 1.',
        capOverride5h: '5h cap override (USD)',
        capOverride7d: '7d cap override (USD)',
        capOverrideTip: 'cap is reverse-derived from utilization, falling back to 7d_P95 (often low). Enter the real cap if you know it; leave empty for auto.',
        rateMultiplier: 'Plan rate multiplier',
        rateMultiplierTip: 'rate_multiplier of the plan group. User-billed cost = upstream cost × multiplier; when > 1, user-side limit scales up. Default 1.',
        pricingTitle: 'Pricing (optional)',
        pricingHint: 'Skip this if you only want limits. Computes suggested price and full-house profit. Formula: price/user = cost × (1+markup) / N; profit = price × N − cost.',
        cost: 'Account cost (¥/mo)',
        markup: 'Markup',
        markupTip: 'Markup = profit / cost. e.g. cost ¥1400, 30% markup → revenue ¥1820, divided by N.',
        suggestedPrice: 'Suggested price/user',
        profit: 'Full-house profit/mo',
        pricingFormula: 'Formula: ¥{cost} × (1+{markup}%) ÷ N({n}) = price/user; profit = price × N − ¥{cost}',
        perMonth: 'mo',
        applyToPlan: 'Create plan with this suggestion',
        warnNoCapSample: 'No utilization sample for this tier — falling back to 7d_P95 estimate. If the account hasn\'t been pushed to limit, fallback will be much lower than real cap. Enter it manually under Advanced.',
        warnSamplesLow: 'Sample size is small (< 3 accounts). Results are rough; collect more data before final decisions.',
        warnNTooHigh: 'Users per account is too high — per-user limit becomes tiny and UX suffers. Consider a smaller N.',
      },
      trendTitle: 'Daily avg cost over the past N days (by tier)',
      trendEmpty: 'No trend data to plot.',
    },

    pricing: {
      title: 'Model Pricing',
      subtitle: 'View default per-model pricing pulled from GitHub. Overlay group/account rate multipliers to see the actual effective price.',
      source: 'Source',
      sourceUnknown: 'No remote source configured (using local fallback)',
      lastUpdated: 'Last Updated',
      modelCount: 'Models',
      viewMode: 'Multiplier View',
      viewMode_default: 'Default (1.0x)',
      viewMode_group: 'By Group',
      viewMode_account: 'By Account',
      viewModeHint: 'Default shows official pricing (×1.0). Switch to "By Group / By Account" to overlay the corresponding rate_multiplier and see the final effective unit price.',
      selectGroup: 'Select Group',
      selectAccount: 'Select Account',
      searchModel: 'Search Model',
      searchPlaceholder: 'Model name / provider keyword',
      ...
      flagCachingTip: 'Supports prompt caching',
    ...
    accounts: {
      ...
      subscriptionTierPlaceholder: 'Select tier (optional)',
      subscriptionTierHint: 'Labeled accounts feed the Pricing Advisor stats, helping you size subscription quotas by tier.',
      subscriptionTierBadge: 'Pricing stats',
      subscriptionTierOptional: 'Optional',
      subscriptionTierDescriptions: {
        unclassified: 'Skip tier aggregation for accounts whose source is not confirmed yet',
        free: 'Free or trial accounts, tracked separately as capacity baseline',
        paid: 'Standard paid tier, used for core plan capacity sizing',
        high: 'High-capacity tier, useful for premium plan sizing',
        team: 'Team or enterprise tier, best tracked separately from personal tiers',
      },
      tierUnclassified: 'Unclassified',
      tierMissing: 'No tier',
      tierMissingHint: 'This subscription account has no tier yet; the Pricing Advisor cannot include it. Edit to set a tier.',
      allPlatforms: 'All Platforms',
      allTypes: 'All Types',
      allStatus: 'All Status',
      allGroups: 'All Groups',
      ...
      bulkResetStatusTitle: 'Bulk Reset Account Status',
      bulkResetStatusConfirm: 'Clear the error state for {count} selected account(s) so they become schedulable again. Continue?',
      bulkRefreshTokenTitle: 'Bulk Refresh Tokens',
      bulkRefreshTokenConfirm: 'Refresh access tokens for {count} selected account(s); accounts that fail will be marked as errored. Continue?',
    ...
    ops: {
      ...
      // System Log
      systemLog: {
        resetRuntimeConfirm: 'Reset to the startup configuration (env/yaml) and apply it immediately?',
        cleanupConfirm: 'Clean up system logs matching the current filters? This action cannot be undone.',
        title: 'System Logs',
        subtitle: 'Sorted by newest first by default; supports filtered search and conditional cleanup.',
        loading: 'Loading...',
        empty: 'No system logs',
        loadFailed: 'Failed to load system logs',
        healthQueue: 'Queue {depth}/{capacity}',
        healthWritten: 'Written {count}',
        healthDropped: 'Dropped {count}',
        healthFailed: 'Failed {count}',
        lastWriteError: 'Last write error: {error}',
        runtimeTitle: 'Runtime Log Config',
        runtimeBadge: 'Applies instantly',
        fieldLevel: 'Level',
        fieldStacktraceLevel: 'Stacktrace Threshold',
        fieldSamplingInitial: 'Sampling Initial',
        fieldSamplingThereafter: 'Sampling Thereafter',
        ...
        runtimeConfigResetDone: 'Rolled back to the startup log configuration',
        runtimeConfigResetFailed: 'Failed to roll back log configuration',
        filterTimeRange: 'Time Range',
        filterStartTime: 'Start Time (optional)',
        filterEndTime: 'End Time (optional)',
        filterLevel: 'Level',
        filterComponent: 'Component',
        filterComponentPlaceholder: 'e.g. http.access',
        filterPlatform: 'Platform',
        filterModel: 'Model',
        filterKeyword: 'Keyword',
        filterKeywordPlaceholder: 'message/request_id',
        levelAll: 'All',
        btnSearch: 'Search',
        btnReset: 'Reset',
        btnCleanupByFilter: 'Clean Up by Current Filters',
        btnRefreshHealth: 'Refresh Health Metrics',
        cleanupDone: 'Cleanup finished, {count} log entries deleted',
    ...
    settings: {
      ...
      features: {
        ...
        invoice: {
          title: 'Invoice',
          description: 'Allow users to request invoices for completed paid orders. The invoiced amount is based on what the user actually paid, excluding bonuses and discounts. Disabled by default.',
          enabled: 'Enable Invoice',
          enabledHint: 'When off, the "My Invoices" entry is hidden and invoice APIs report the feature as disabled.',
        },
        affiliate: {
      ...
      registration: {
        ...
        ipLimitTitle: 'Registration IP Limit (anti-abuse)',
        ipLimitHint: 'Beyond the route-level 5/min hard floor, throttle registrations per IP over a longer window. Combined with Gmail alias normalization, this effectively blocks new-user reward farming.',
        ipLimitMaxCount: 'Max registrations per window',
        ipLimitMaxPlaceholder: '0 = disabled',
        ipLimitMaxNote: '0 = disabled (only routes 5/min applies); recommended 3 (3 per IP per hour)',
        ipLimitWindow: 'Window length (minutes)',
        ipLimitWindowPlaceholder: '60',
        ...
        aiReviewTestButton: 'Test AI Review',
        aiReviewTestTitle: 'AI Review Test',
        aiReviewTestHint: 'Enter a snippet of text to see how the configured model + prompt would classify it. Results are not persisted.',
        aiReviewTestPromptLabel: 'Test content',
        aiReviewTestPlaceholder: 'Paste a request that was caught by the safety filter to verify whether AI judges it pass / flag / reject correctly',
        aiReviewTestRun: 'Run test',
      ...
      site: {
        ...
        contactMethodLabel: 'Display Name',
        contactMethodValue: 'Account / Number',
      ...
      payment: {
        ...
        quickAmountsPlaceholder: 'e.g. 10,20,50,100,200',
        quickAmountsHint: 'Separate amounts with commas, up to {max} values. Leave empty to use defaults.',
        quickAmountsPreview: 'User preview',
        quickAmountsFormatError: 'Quick recharge amounts are invalid. Enter positive numbers separated by commas, up to {max}.',
        ...
        field_callbackUrl: 'Cancel Redirect URL',
  ...
  exclusiveSeats: {
    ...
    usageMonthly: 'This Month',
    daysLeft: '{days} days left',
    expiringNow: 'Expiring',
    renew: 'Renew',
    renewTitle: 'Renew Exclusive Seat',
    renewHint: 'Extend the validity for "{name}". The bound account stays the same.',
    renewPaymentHint: 'Renewal requires repaying the plan price. Click "Go to Pay" to continue on the purchase page.',
    priceIncreasedWarning: 'Plan price increased by ¥{delta}; please confirm before paying.',
    priceDecreasedNote: 'Plan price dropped by ¥{delta}; the discounted price applies to this renewal.',
    priceUnchangedNote: 'Plan price unchanged from your last payment.',
    goToPay: 'Go to Pay',
    usageGuideTitle: 'You need an ApiKey to use your exclusive seat',
    usageGuideHint: 'Create an ApiKey bound to the matching group on the API Keys page; the scheduler will then route your requests to your dedicated account.',
    goToKeys: 'Go to ApiKey',
    validityDays: 'Validity (days)',
    status: {
      active: 'Active',
      expired: 'Expired',
  ...
  invoice: {
    title: 'My Invoices',
    subtitle: 'Request invoices — the invoice amount equals the actual amount you paid',
    ...
    actions: {
      ...
      confirmCancel: 'Cancel this invoice request? The related orders will become available again.',
    },
    apply: {
      button: 'Request Invoice',
      title: 'Request Invoice',
      availableTitle: 'Available invoiceable amount',
      availableHint: 'Based on your real consumption in invoice-eligible groups; recharge bonuses and relayed-group usage are excluded.',
      amountLabel: 'Invoice amount (CNY)',
      amountPlaceholder: 'Leave blank to invoice the full available amount',
      amountHint: 'You can enter less than the available amount for a partial invoice; the remainder stays invoiceable next time.',
      submit: 'Submit',
      success: 'Invoice request submitted',
      companyNamePlaceholder: 'Enter company name',
      personalNamePlaceholder: 'Enter individual name (defaults to "Individual")',
      taxIdPlaceholder: 'Enter taxpayer ID',
      emailPlaceholder: 'Email to receive the e-invoice',
      remarkPlaceholder: 'Optional, note any special requirements',
    },
    summary: {
      title: 'Invoiceable Amount',
      balance: 'From balance usage',
      plan: 'From plan payments',
      invoiced: 'Applied / Issued',
    },
    detail: {
      title: 'Invoice Detail',
      relatedOrders: 'Related Orders',
      emailSent: 'The invoice has been sent to the recipient email',
      emailPending: 'Invoice issued, email is being sent',
    },
    admin: {
      searchPlaceholder: 'Search title / email / tax ID',
      applicant: 'Applicant',
      issue: 'Issue',
      reject: 'Reject',
      issueTitle: 'Issue Invoice',
      uploadPdf: 'Upload Invoice PDF',
      uploadHint: 'The PDF is only used to email the customer and extract the number; the file is not stored',
      chooseFile: 'Choose PDF',
      changeFile: 'Change File',
      parsing: 'Parsing...',
      invoiceNumberPlaceholder: 'Enter manually if parsing fails',
      issueNote: 'On confirm, the PDF is emailed to the customer and the invoice number is stored (the PDF file is not kept)',
      confirmIssue: 'Issue & Send',
      issuing: 'Issuing...',
      issueSuccess: 'Invoice issued and sent',
      rejectTitle: 'Reject Invoice Request',
      rejectNote: 'After rejection the related orders are released and the customer can re-apply.',
      rejectReasonPlaceholder: 'Explain the reason; it will be shown to the customer',
    },
    errors: {
      INVOICE_NOT_FOUND: 'Invoice request not found',
      INVOICE_NOT_OWNED: 'Not allowed to operate this invoice request',
      INVOICE_NOT_PENDING: 'This request has already been processed',
      INVOICE_NOTHING_TO_INVOICE: 'No invoiceable amount available',
      INVOICE_AMOUNT_EXCEEDS_AVAILABLE: 'Invoice amount exceeds the available amount, please refresh and retry',
      INVOICE_TAX_ID_REQUIRED: 'Tax ID is required for company invoices',
      INVOICE_INVALID_TITLE: 'Invalid invoice title',
      INVOICE_INVALID_EMAIL: 'Invalid recipient email',
      INVOICE_NUMBER_REQUIRED: 'Please enter the invoice number',
      INVOICE_PDF_REQUIRED: 'Please upload the invoice PDF',
      INVOICE_PDF_TOO_LARGE: 'Invoice PDF exceeds the 10MB limit',
      INVOICE_PDF_INVALID: 'Only PDF files are supported',
      INVOICE_PDF_EMPTY: 'The invoice PDF is empty',
      INVOICE_DISABLED: 'Invoice feature is disabled',
    },
  },
  ...
  payment: {
    ...
    renewalBanner: {
      title: 'Renewing Exclusive Seat',
      hint: 'Validity will be extended automatically; bound account stays the same.',
      hintUp: 'Plan price increased — please confirm before paying.',
      hintDown: 'Plan price dropped — discounted price applies.',
      lastPaid: 'Last paid',
      thisTime: 'This time',
      priceUp: 'up by ¥{delta}',
      priceDown: 'down by ¥{delta}',
    ...
    orders: {
      ...
      viewRefund: 'View Refund Details',
      refundDetailsTitle: 'Refund Details',
      refundAmountLabel: 'Refund Amount',
      refundPartialNote: 'Original ¥{paid}, partial refund only',
      refundedAt: 'Refunded At',
      refundRequestedAt: 'Requested At',
      refundOriginalRoute: 'Original Route',
      refundProcessHint: 'Refunds typically arrive in your payment account within 1-5 business days.',
      refundReasonCodes: {
        exclusive_pool_sold_out: 'Exclusive pool sold out — full refund issued automatically',
      },
    },
    result: {
    ...
    subscriptionGuide: {
      title: 'Subscription is usually better value',
      subtitle: '{count} subscription plan(s) are available. For frequent use, subscribing is usually easier than repeated top-ups.',
      subtitleWithPrice: '{count} subscription plan(s) are available, starting at ¥{price}. For frequent use, subscribing is usually easier.',
      action: 'View plans',
    },
    tabTopUp: 'Top Up',
    tabSubscribe: 'Subscribe',
    noPlans: 'No subscription plans available',
    noPlansHint: 'No plans have been listed yet. Please contact support or check back later.',
    noPlansTitle: 'No subscription plans yet',
    ...
    invoiceNotice: 'Invoicing note: only consumption in invoice-eligible groups can be invoiced; recharge bonuses and redeem codes are excluded. Unspent balance is not invoiceable until consumed.',
    invoiceEligible: 'Consumption under this plan is invoiceable',
    invoiceIneligible: 'Consumption under this plan is not invoiceable — please note before purchasing',
    refundReason: 'Refund Reason',
    ...
    planCard: {
      ...
      tierBadgeHint: 'This plan has its own limit config, distinct from other plans in the same group',
      popularBadge: 'Popular',
      subscribed: 'Subscribed · {days}d left',
    },
    days: 'days',
    months: 'months',
    years: 'years',
    ...
    admin: {
      ...
      planKind: 'Plan Type',
      planKindShared: 'Shared Pool',
      planKindExclusive: 'Exclusive Pool',
      planKindSharedHint: 'Shared pool plan: users share accounts inside the group with other subscribers.',
      planKindExclusiveHint: 'Exclusive pool plan: each subscriber is bound to a dedicated account from the pool for the whole subscription period.',
      limitOverrideTitle: 'Plan Limit Override',
      limitOverrideHint: 'Leave blank to inherit the group default. Set a value to override (used to differentiate Lite/Pro/Max tiers within the same group).',
      planDailyLimitUSD: 'Daily Limit (USD)',
      planWeeklyLimitUSD: 'Weekly Limit (USD)',
      planMonthlyLimitUSD: 'Monthly Limit (USD)',
      planRateMultiplier: 'Rate Multiplier',
      limitInheritGroup: 'blank = inherit',
      limitHint: '0 or blank = unlimited',
      warnWeeklyRedundant: 'Value has no effect: capped by daily × 7 (actual ceiling ${max})',
      warnMonthlyRedundant_daily: 'Value has no effect: capped by daily × 30 (actual ceiling ${max})',
      warnMonthlyRedundant_weekly: 'Value has no effect: capped by weekly × 30/7 (actual ceiling ${max})',
      warnMonthlyRedundant_both: 'Value has no effect: capped by daily and weekly limits (actual ceiling ${max})',
      kindBadgeExclusive: 'Exclusive',
      stockAvailable: '{n} left',
      ...
      exclusivePools: {
        ...
        subtitle: 'View per-pool inventory and manage seats: grant, release, swap, extend.',
        poolGroup: 'Select Pool (Group)',
        grantButton: 'Grant Seat',
        grantTitle: 'Admin: Grant Exclusive Seat',
        targetUserID: 'User ID',
        targetPlanID: 'Plan ID',
        validityDays: 'Validity (days)',
        notes: 'Notes',
        noPlansForPool: 'No exclusive plans available for this pool. Create an exclusive plan and bind it to this group first.',
        planMustBelongToPool: 'The selected plan does not belong to this exclusive pool. Please choose a plan from this pool.',
        userSearchPlaceholder: 'Search user by ID / email / username',
        userSearchSelected: 'Selected',
        userSearchNoMatch: 'No matching user. Try a different keyword.',
        statTotal: 'Total',
        statFree: 'Free',
        statAvailableNow: 'Available Now',
        statFreeRaw: 'Free (incl. rate-limited) {n}',
        statSchedulable: '{n} schedulable now',
        statSchedulableHint: 'Truly sellable count after excluding rate-limited/overloaded/temp-unavailable accounts',
        statUsed: 'Used',
        statExpiring: 'Expiring in 7d',
        statExpiringClickFilter: 'Click to filter',
        statExpiringClickClear: 'Click to clear filter',
        expiringFilterActive: 'Showing only active seats expiring within 7 days',
        expiringFilterClear: 'Clear filter',
        emptyExpiring: 'No active seats expiring in the next 7 days',
        colUser: 'User',
        colAccount: 'Account',
        colStatus: 'Status',
        ...
        actSwap: 'Swap',
        actRelease: 'Release',
        releaseTitle: 'Force Release Seat',
        releaseHint: 'Releasing #{id}; the bound account will return to the pool.',
        reason: 'Reason',
        extendTitle: 'Extend / Shorten',
        extendDays: 'Days (positive to extend, negative to shorten)',
        extendHint: 'Extending keeps the bound account; shortening cannot push expiry into the past.',
        extendPreviewCurrent: 'Current expiry',
        extendPreviewDelta: 'Change',
        extendPreviewNew: 'New expiry',
        extendPreviewInvalidPast: 'The resulting expiry is in the past; please adjust.',
        daysSuffix: 'd',
        swapConfirm: 'Pick a new free account from the pool? The current account will be released.',
        swapTitle: 'Swap Confirmation',
        swapDialogHint: 'This will pick a new free account from the pool for this seat and immediately release the current account back to the pool.',
        swapDialogOldAccount: 'Current account',
        swapDialogWarn: 'Swapping may invalidate the user’s current session/cache. Confirm only if intended.',
      },
      ...
      planLabelPlaceholder: 'Auto if blank (e.g. Lite / Pro)',
      planLabelHint: 'Column header in the comparison table. Leave blank to auto-derive from the plan name.',
      ...
      tierStyle: {
        label: 'Tier Style',
        hint: 'Icon + color for this tier in the comparison table; higher = more premium',
        basic: 'Basic',
        standard: 'Standard',
        advanced: 'Advanced',
        flagship: 'Flagship',
      ...
      quotaPriceRate: 'Price / quota',
      billingRate: 'Billing rate',
      effectiveCostRate: 'Effective',
      costMultiplierUnavailable: 'Set a price and a matching daily/weekly/monthly USD limit to calculate.',
      periodQuotaUsed: 'Using same-period quota: {quota}',
      costMultiplierTitle: 'Quota {quota}; price/quota {quotaRate}; billing {billingRate}; effective {effectiveRate}',
      targetCostMultiplier: 'Target cost rate',
      targetCostMultiplierPlaceholder: 'e.g. 1.25',
      periodQuotaInput: 'Same-period quota',
      periodQuotaInputPlaceholder: 'Auto quota / enter quota',
      costCalculatorHint: 'Formula: price / same-period quota × billing rate = target cost rate.',
      costCalculatorTarget: 'Will write {field}: {value}.',
      costCalculatorUnavailable: 'Set a valid billing period before using the calculator.',
      isPopular: 'Mark as Popular',
      isPopularHint: 'Plan card shows "Popular" badge + amber accent border',
      ...
      bulkActionDone: 'Done. {n} succeeded',
      bulkActionPartialFail: '{n} failed, please retry',
      ...
      financeDesc: 'Settlement-oriented real income by month or by day',
      financePeriodMonth: 'By Month',
      financePeriodDay: 'By Day',
      financeMonth: 'Month',
      financeDate: 'Date',
      financeNetIncome: 'Real Income',
      financeGrossIncome: 'Gross Paid',
      financeRefunds: 'Refund Deduction',
      financeAvgOrder: 'Average Net',
      financeLedgerNote: 'Scope: completed orders and partially refunded net income only. Fully refunded, pending and in-progress refund orders are excluded.',
      colDate: 'Date',
      netIncome: 'Real Income',
      grossIncome: 'Gross Paid',
