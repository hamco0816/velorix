export default {
  ...
  invoice: {
    ...
    apply: {
      ...
      selectOrders: 'Invoiceable Orders',
      amountHint: 'Only completed orders with an actual payment are invoiceable',
      invoiceableSummary: 'System invoiceable amount',
      autoApplyHint: 'All completed paid orders that have not been invoiced will be included automatically.',
      previewOrders: 'Invoiceable order preview',
      previewOrdersHint: 'When there are many orders, this preview is paginated; submitting includes all invoiceable orders.',
      includedOrders: '{count} orders included',
      noOrders: 'No invoiceable orders',
      total: 'Total',
      submit: 'Submit',
    ...
    errors: {
      ...
      INVOICE_NO_ORDERS: 'No invoiceable orders',
      INVOICE_ORDER_NOT_USABLE: 'Some orders are not invoiceable, please refresh and retry',
  ...
  payment: {
    ...
    admin: {
      ...
      recommendedTierHint: 'Highlights this column in the comparison table. Set only one per group.',
