export default {
  ...
  admin: {
    ...
    pricingAdvisor: {
      ...
      subtitle: 'Estimate peak 5h/7d window cost per account tier from historical usage, helping you size subscription quotas and pricing.',
      daySuffix: 'd',
      helpTitle: 'How to read & use this',
      helpBody: 'Stats are the rolling 5h/7d peak cost per account over the past N days. Treat them as "single-account peak load", divide by expected shared users (with a safety factor), and you get the per-user subscription quota.',
      ...
      calculator: {
        ...
        marginTip: 'Target gross margin, affects the suggested price. e.g. cost 1400, 7 users, 30% margin → suggested ¥260/mo.',
        ...
        concurrencyTip: 'Expected fraction of users actively running heavy load at peak. e.g. 33% means ~2-3 of 7 users at the same time. Use higher (50-70%) for power-user heavy workloads, lower (20-30%) for casual users.',
        selectFirst: 'Pick a tier first, then fill in cost and user count.',
        resultTitle: 'Suggested plan',
        suggestedPrice: 'Suggested price',
        suggestedMonthly: 'Per-user monthly',
        suggested5h: 'Per-user 5h',
        suggested7d: 'Per-user 7d',
        profit: 'Projected profit',
        perMonth: 'mo',
        limitsTitle: 'Per-user rolling-window limits (USD)',
        applyToPlan: 'Create plan with this suggestion',
        warnOverP95: 'Total limit exceeds historical P95; multiple users may hit the cap simultaneously during peaks.',
