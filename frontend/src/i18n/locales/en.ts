  ...
  admin: {
    ...
    pricingAdvisor: {
      ...
      tip: {
        ...
        dailyAvg: 'Average daily cost actually consumed per account over the past N days (= total cost ÷ accounts ÷ days). This is "how much was used", not "how much is left" — capacity comes from the reverse-derived cap shown in the calculator.',
      ...
      calculator: {
        ...
        usersPerAccountTip: 'How many subscribers will share one account. The upstream cap × safety is split across N users to derive each user\'s daily / weekly / monthly / 5h limit.',
        ...
        limitsTip: '5h limit = cap_5h × safety × rate_multiplier / N; weekly = cap_7d × safety × rate_multiplier / N; daily = weekly/7; monthly = weekly×4.',
