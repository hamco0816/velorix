export default {
  ...
  invoice: {
    ...
    apply: {
      ...
      title: '申请开票',
      selectOrders: '可开票订单',
      amountHint: '仅可对已完成、实付金额的订单开票',
      invoiceableSummary: '系统自动开票金额',
      autoApplyHint: '系统会自动纳入全部已完成且未开票的实付订单，避免重复开票。',
      previewOrders: '可开票订单预览',
      previewOrdersHint: '订单较多时仅分页预览，提交时会自动包含全部可开票订单。',
      includedOrders: '纳入订单 {count} 笔',
      noOrders: '暂无可开票订单',
      total: '开票合计',
      submit: '提交申请',
      success: '开票申请已提交',
    ...
    errors: {
      ...
      INVOICE_ORDER_NOT_USABLE: '部分订单不可开票，请刷新后重试',
  ...
  payment: {
    ...
    admin: {
      ...
      recommendedTier: '推荐档',
      recommendedTierHint: '开启后该档在对比表里整列高亮；每组只设一个。',
      planBadgeText: '套餐标签',
