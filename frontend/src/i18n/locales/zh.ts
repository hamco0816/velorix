export default {
  ...
  admin: {
    ...
    pricingAdvisor: {
      title: '订阅定价助手',
      subtitle: '基于历史用量数据，按账号档位估算 5h/7d 滚动窗口峰值成本，辅助你给订阅套餐合理定额、定价。',
      daySuffix: '天',
      helpTitle: '数据怎么来的，怎么用',
      helpBody: '统计基于过去 N 天每个账号的"5h/7d 滑动窗口峰值成本"。把它当作"单账号单时段最高负载"，再除以预期共享人数（带安全系数），就是给套餐用户的限额建议。样本越多越稳定。',
      ...
      calculator: {
        ...
        users: '共享人数',
        margin: '期望利润率',
        marginTip: '期望毛利率，影响建议价格。例如成本 1400、人数 7、利润率 30% → 建议月费 ¥260。',
        safety: '安全系数',
        safetyTip: '< 1 = 按 P50 的百分比定额，越小越保守、撞顶风险越低，但用户可能感觉"不够用"；建议 0.7-0.85。',
        concurrency: '峰值并发系数',
        concurrencyTip: '估计高峰时段同时活跃的用户比例。例如 33% 表示 7 人里高峰大概 2-3 人同时高负载。用户类型偏 power user 时设高（50-70%），偏轻量用户设低（20-30%）。',
        selectFirst: '请先选择档位，再填入成本和人数。',
        resultTitle: '建议方案',
        suggestedPrice: '建议月费',
        suggestedMonthly: '每人月限额',
        suggested5h: '每人 5h',
        suggested7d: '每人 7d',
        profit: '预计月利润',
        perMonth: '月',
        limitsTitle: '每人滚动窗口限额（USD）',
        applyToPlan: '用此建议创建套餐',
        warnOverP95: '建议总限额超过历史 P95，部分时段可能多人同时撞顶。',
    ...
    accounts: {
      ...
      subscriptionTierHint: '标注后会出现在「订阅定价助手」的统计里，用于按档位聚合 5h/7d 用量、辅助你给套餐定额。',
