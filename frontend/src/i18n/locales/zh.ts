  ...
  admin: {
    ...
    pricingAdvisor: {
      ...
      tip: {
        ...
        dailyAvg: '过去 N 天每账号每日实际消耗均值（= 总消耗 ÷ 账号数 ÷ 天数）。这是"实际用了多少"，不是"还能用多少"——容量看下方计算器里反推出的 cap。',
      ...
      calculator: {
        ...
        usersPerAccountTip: '你打算让多少个订阅用户共用一个账号。系统把上游 cap × 安全系数后均分给这 N 个用户，得每个用户的日 / 周 / 月 / 5h 限额。',
        safety: '安全系数',
        ...
        limitsTip: '5h 限额 = cap_5h × safety × 套餐倍率 / N；周 = cap_7d × safety × 套餐倍率 / N；日 = 周/7；月 = 周×4。',
