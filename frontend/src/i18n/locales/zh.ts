export default {
  ...
  admin: {
    ...
    pricingAdvisor: {
      ...
      helpBody: '统计基于过去 N 天每个账号的"7 天滑动窗口峰值成本"。把它当作"单账号一周内最高负载"，再乘安全系数除以单用户月限额，得到单账号能服务的用户数，进而推算月费。样本越多越稳定。',
      ...
      calculator: {
        ...
        tier: '档位',
        cost: '账号成本（¥/月）',
        targetUserLimit: '目标单用户月限额（USD）',
        targetUserLimitTip: '你想给每个订阅用户每月最多用多少（token 美元值）。系统据此推算该账号能服务几个用户、应该卖多少钱。',
        margin: '期望利润率',
        marginTip: '期望毛利率，影响建议价格。例：账号成本 ¥1400、利润率 30% → 总收入目标 ¥1820，再除以推算人数得到单人月费。',
        safety: '安全系数',
        safetyTip: '< 1 = 按 P50 的百分比定额，越小越保守、撞顶风险越低，但用户可能感觉"不够用"；建议 0.7-0.85。',
        selectFirst: '请先选择档位，再填写参数。',
        resultTitle: '建议方案',
        suggestedPrice: '建议月费',
        derivedUsers: '推算可分配人数',
        derivedUsersTip: '基于该档位历史 P50 7d 峰值（×4 模拟一个月）× 安全系数 ÷ 你定的单人月限额。',
        suggestedDaily: '日限额',
        suggestedWeekly: '周限额',
        ...
        warnOverP95: '推算总用量超过历史 P95，部分时段可能多人同时撞顶。',
        warnSamplesLow: '样本不足（< 3 个账号），建议结果仅供参考，等多积累几个账号再决策。',
        warnTooFewUsers: '按当前单人限额，单账号只能服务 < 1 人。请调小单人月限额或换更高档位。',
      },
